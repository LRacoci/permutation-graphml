""" GraphNets model architectures modified """
...
class MLPRelationNetwork(snt.AbstractModule):
    """RelationNetwork with MLP edge and global models."""
    ...
    def __init__(self,
        ...
        with self._enter_variable_scope():
            if network == "GraphIndependent":
                ...
                self._output_transform = modules.RelationNetwork(edge_fn, global_fn)
