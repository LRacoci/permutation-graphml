...
def create_feed_dict(rand, batch_size, num_nodes_min_max, theta, input_ph,
  ...
  input_ge = utils_np.networkxs_to_graphs_tuple(inputs)
  target_ge = utils_np.networkxs_to_graphs_tuple(targets)
  feed_dict_ge = {input_ph: input_ge, target_ph: target_ge}
...
for iteration in range(last_iteration, num_training_iterations):
  ...
  feed_dict, feed_dict_ge = create_feed_dict(rand, batch_size_tr, num_nodes_min_max_tr,
