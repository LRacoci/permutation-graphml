...
Original file is located at
    https://colab.research.google.com/drive/1FsmNIOk6veWUM53rQ1530hpASPfInEZk
"""
...
for iteration in range(last_iteration, num_training_iterations):
  ...
  if iteration % 1000 == 0:
    ...
    print("raw_graphs = ", raw_graphs[0].edges)
  ...
  if True:#elapsed_since_last_log > log_every_seconds:
    ...
    raw_graphs_ge = generate_raw_graphs(rand, batch_size_ge, num_nodes_min_max_ge, theta)
    ...
    perm = [rand.permutation(len(raw_graphs_ge[i].nodes)) for i in range(len(raw_graphs_ge))]
    ...
    test_values_ge_perm = sess.run({
        "target_perm": target_ph_ge_perm,
        "loss_perm": loss_op_ge_perm,
        "outputs_perm": output_ops_ge_perm
    },
    ...
    correct_ge_perm, solved_ge_perm = compute_accuracy(
        test_values_ge_perm["target_perm"], test_values_ge_perm["outputs_perm"][-1], use_edges=True)
    ...
    losses_ge_perm.append(test_values_ge_perm["loss_perm"])
...
#               test_values_ge_perm["loss_perm"], correct_tr, solved_tr, correct_ge, solved_ge,
