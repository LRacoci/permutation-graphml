...
Original file is located at
    https://colab.research.google.com/drive/11eGkUXd1kEk-8-fL6lpIvNWHYeqQmd0C
"""
...
for iteration in range(last_iteration, num_training_iterations):
  ...
  if elapsed_since_last_log > log_every_seconds:
    ...
    perm = [np.random.permutation(len(raw_graphs[i].nodes)) for i in range(len(raw_graphs))]
...
#     print("perm: ", perm)
    ...
    #Permute raw_graphs
    raw_graphs2 = [
        nx.relabel_nodes(raw_graphs[i], mapping={i: p for i,p in enumerate(perm[i])}) 
